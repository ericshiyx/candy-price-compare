...
async function scrapePrice(url) {
    try {
        console.log('Starting vendor2 price scraping for URL:', url);
        ...
        console.log('Final price for vendor2:', price);
        return price;
    } catch (error) {
        console.error('Detailed error in vendor2 scraping:', error);
